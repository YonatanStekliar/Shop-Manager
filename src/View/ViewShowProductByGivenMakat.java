...
public class ViewShowProductByGivenMakat {
	private BorderPane bp;
	private TextField search;
	private Text text;
	private VBox showProduct;
	private HBox hbField;
	private Button ok,bClose;
	private Stage stage;

	public ViewShowProductByGivenMakat(Stage stage) {
		this.stage = stage;
		bClose = new Button("Close");
		bp = new BorderPane();
		text = new Text("Please Enter A Catalog Number:");
		...
		stage.setTitle("Show Products By Given Makat");
	...
	public void addCloseButton() {
		showProduct.getChildren().add(bClose);
	}
	
	public void closeSearchByGivenMakat() {
		stage.close();
	}
	
	public void closeAction(EventHandler<ActionEvent> event) {
